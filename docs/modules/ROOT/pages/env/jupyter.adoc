...
:page-course-concepts: jupyter, asciidoc, notebook
:page-course-outcomes: create a Jupyter notebook from AsciiDoc, add executable code cells, export a notebook for local execution
...
You write your notebook in AsciiDoc including LaTeX math and thanks to the `:page-jupyter: true` attribute, the UI can offer a Jupyter notebook download. The page must also be selected for export in the Jupyter extension configuration in `site.yml`; the attribute alone does not generate a file.
