...
IMPORTANT: Static preview: Python cells have not been executed in this build. Download the notebook to run the experiment; this preview is not a verified teaching release.
endif::[]
ifndef::course-static-preview[]
...
Here latexmath:[u] is a state field and latexmath:[\mu] controls diffusion relative to reaction. A supplied finite-difference solver lets you focus on interpretation.
...
All solver code and synthetic data needed for this experiment are included in the notebook.
